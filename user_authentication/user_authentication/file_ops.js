...
//fs.appendFileSync("./Storage/info.txt","sehrish siddique");
//const read = fs.readFileSync("./Storage/info.txt", "utf8");
//
//console.log(read); 
//fs.writeFileSync("./Storage/info.txt","SS");
//const read1 = fs.readFileSync("./Storage/info.txt", "utf8");
//
//console.log(read1); 
